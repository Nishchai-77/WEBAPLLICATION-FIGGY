                    ...
                    <div class="right-info">
                        ...
                        <form id="form-submit" action="" method="get">
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        <select required name='dishes' onchange='this.form.()'>
                                            ...
                                            <option value="tomato bath">PAV BHAJI</option>
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        <input name="price" type="phone" class="form-control" id="price"  value="150 rs" placeholder="50 rs" required>
                                    </fieldset>
                                </div>
